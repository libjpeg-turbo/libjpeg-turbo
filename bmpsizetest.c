...
static int test_read_BMP(int width, int height, boolean use_inversion_array)
{
...
static int test_read_GIF(int width, int height, boolean interlaced)
{
  struct jpeg_compress_struct cinfo;
  struct my_error_mgr myerr;
  struct jpeg_error_mgr *jerr = &myerr.pub;
...
static int test_read_PPM(int width, int height, int foo)
{
  struct jpeg_compress_struct cinfo;
  struct my_error_mgr myerr;
  struct jpeg_error_mgr *jerr = &myerr.pub;
...
static int test_write_PPM(int width, int height, int foo)
{
  struct jpeg_decompress_struct cinfo;
  struct my_error_mgr myerr;
  struct jpeg_error_mgr *jerr = &myerr.pub;
...
static int test_read_TGA(int width, int height, boolean top_down)
{
  struct jpeg_compress_struct cinfo;
  struct my_error_mgr myerr;
  struct jpeg_error_mgr *jerr = &myerr.pub;
...
#define TESTREAD(EXT, w, h, opt_desc, opt, retval, expected_error_str) { \
  error_str[0] = 0; \
  if (test_read_##EXT(w, h, opt) != retval) { \
...
int main(void)
{
  ...
  TESTREAD(BMP, JPEG_MAX_DIMENSION, JPEG_MAX_DIMENSION + 1, "bottom-up", FALSE,
           -1, "Maximum supported image dimension is 65500 pixels");
  TESTREAD(BMP, JPEG_MAX_DIMENSION + 1, JPEG_MAX_DIMENSION, "bottom-up", FALSE,
           -1, "Maximum supported image dimension is 65500 pixels");
  TESTREAD(BMP, JPEG_MAX_DIMENSION, JPEG_MAX_DIMENSION, "bottom-up", FALSE, 0,
           "");
  TESTREAD(BMP, JPEG_MAX_DIMENSION, JPEG_MAX_DIMENSION + 1, "top-down", TRUE,
           -1, "Maximum supported image dimension is 65500 pixels");
  TESTREAD(BMP, JPEG_MAX_DIMENSION + 1, JPEG_MAX_DIMENSION, "top-down", TRUE,
           -1, "Maximum supported image dimension is 65500 pixels");
  TESTREAD(BMP, JPEG_MAX_DIMENSION, JPEG_MAX_DIMENSION, "top-down", TRUE, 0,
           "");
  ...
  TESTREAD(GIF, JPEG_MAX_DIMENSION, JPEG_MAX_DIMENSION + 1, "non-interlaced",
           FALSE, -2, "Maximum supported image dimension is 65500 pixels");
  TESTREAD(GIF, JPEG_MAX_DIMENSION + 1, JPEG_MAX_DIMENSION, "non-interlaced",
           FALSE, -2, "Maximum supported image dimension is 65500 pixels");
  TESTREAD(GIF, JPEG_MAX_DIMENSION, JPEG_MAX_DIMENSION, "non-interlaced",
           FALSE, 0, "");
  TESTREAD(GIF, JPEG_MAX_DIMENSION, JPEG_MAX_DIMENSION + 1, "interlaced", TRUE,
           -2, "Maximum supported image dimension is 65500 pixels");
  TESTREAD(GIF, JPEG_MAX_DIMENSION + 1, JPEG_MAX_DIMENSION, "interlaced", TRUE,
           -2, "Maximum supported image dimension is 65500 pixels");
  TESTREAD(GIF, JPEG_MAX_DIMENSION, JPEG_MAX_DIMENSION, "interlaced", TRUE, 0,
           "");
  ...
  TESTREAD(PPM, JPEG_MAX_DIMENSION, JPEG_MAX_DIMENSION + 1, "8-bit", 0, -1,
           "Maximum supported image dimension is 65500 pixels");
  TESTREAD(PPM, JPEG_MAX_DIMENSION + 1, JPEG_MAX_DIMENSION, "8-bit", 0, -1,
           "Maximum supported image dimension is 65500 pixels");
  TESTREAD(PPM, JPEG_MAX_DIMENSION, JPEG_MAX_DIMENSION, "8-bit", 0, 0, "");

  fprintf(stderr, "\n");

  fprintf(stderr, "Testing PPM writer ...\n");

  TESTWRITE(PPM, JPEG_MAX_DIMENSION, JPEG_MAX_DIMENSION + 1, "8-bit", 0, -1,
            "Maximum supported image dimension is 65500 pixels");
  TESTWRITE(PPM, JPEG_MAX_DIMENSION + 1, JPEG_MAX_DIMENSION, "8-bit", 0, -1,
            "Maximum supported image dimension is 65500 pixels");
  TESTWRITE(PPM, JPEG_MAX_DIMENSION, JPEG_MAX_DIMENSION, "8-bit", 0, 0, "");
  ...
  TESTREAD(TGA, JPEG_MAX_DIMENSION, JPEG_MAX_DIMENSION + 1, "bottom-up", FALSE,
           -1, "Maximum supported image dimension is 65500 pixels");
  TESTREAD(TGA, JPEG_MAX_DIMENSION + 1, JPEG_MAX_DIMENSION, "bottom-up", FALSE,
           -1, "Maximum supported image dimension is 65500 pixels");
  TESTREAD(TGA, JPEG_MAX_DIMENSION, JPEG_MAX_DIMENSION, "bottom-up", FALSE, 0,
           "");
  TESTREAD(TGA, JPEG_MAX_DIMENSION, JPEG_MAX_DIMENSION + 1, "top-down", TRUE,
           -1, "Maximum supported image dimension is 65500 pixels");
  TESTREAD(TGA, JPEG_MAX_DIMENSION + 1, JPEG_MAX_DIMENSION, "top-down", TRUE,
           -1, "Maximum supported image dimension is 65500 pixels");
  TESTREAD(TGA, JPEG_MAX_DIMENSION, JPEG_MAX_DIMENSION, "top-down", TRUE, 0,
           "");
  ...
  TESTWRITE(TGA, JPEG_MAX_DIMENSION, JPEG_MAX_DIMENSION + 1, "top-down", 0, -1,
            "Maximum supported image dimension is 65500 pixels");
  TESTWRITE(TGA, JPEG_MAX_DIMENSION + 1, JPEG_MAX_DIMENSION, "top-down", 0, -1,
            "Maximum supported image dimension is 65500 pixels");
