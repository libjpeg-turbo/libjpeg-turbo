...
6. Hardened the TurboJPEG API against hypothetical applications that may
...
8. Hardened the TurboJPEG Java API against hypothetical applications that may
...
10. The SIMD dispatchers now use `getauxval()` or `elf_aux_info()`, if
available, to detect support for Neon and AltiVec instructions on AArch32 and
PowerPC Linux, Android, and *BSD systems.

11. Hardened the libjpeg API against hypothetical applications that may
...
12. Fixed a division-by-zero error that occurred when attempting to use the
...
13. Fixed an issue in the TurboJPEG API library's data destination manager that
manifested as:
...
15. Further hardened the TurboJPEG Java API against hypothetical applications
...
17. Fixed a buffer overrun and subsequent segfault in jpegtran that occurred
...
18. Fixed an integer overflow and subsequent buffer overrun that occurred when
...
20. Fixed a buffer overrun and subsequent segfault that occurred on certain
...
21. Hardened the libjpeg API against hypothetical applications that may
...
22. Fixed issues in `jpeg*_skip_scanlines()` whereby, when skipping certain
...
23. Hardened the TurboJPEG API against hypothetical applications that may
