...
3. Fixed a buffer overrun and subsequent segfault in jpegtran that occurred
...
5. Fixed an issue whereby `tj3DecompressToYUV*()` produced incorrect
...
8. Fixed issues in `jpeg*_skip_scanlines()` whereby, when skipping certain
