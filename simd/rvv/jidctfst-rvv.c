...
#define DO_IDCT(in) { \
    ...
    pdt = __riscv_vwmul_vx_i32m2(tmp12, FIX_1_414, vl); \
    tmp12 = __riscv_vnsra_wx_i16m1(pdt, CONST_BITS, vl); \
    ...
    pdt = __riscv_vwmul_vx_i32m2(tmp11, FIX_1_414, vl); \
    tmp11 = __riscv_vnsra_wx_i16m1(pdt, CONST_BITS, vl); \
    \
    z5 = __riscv_vadd_vv_i16m1(z10, z12, vl); \
    pdt = __riscv_vwmul_vx_i32m2(z5, FIX_1_847, vl); \
    z5 = __riscv_vnsra_wx_i16m1(pdt, CONST_BITS, vl); \
    \
    pdt = __riscv_vwmul_vx_i32m2(z12, FIX_1_082, vl); \
    tmp10 = __riscv_vnsra_wx_i16m1(pdt, CONST_BITS, vl); \
    tmp10 = __riscv_vsub_vv_i16m1(tmp10, z5, vl); \
    pdt = __riscv_vwmul_vx_i32m2(z10, -FIX_2_613, vl); \
    tmp12 = __riscv_vnsra_wx_i16m1(pdt, CONST_BITS, vl); \
