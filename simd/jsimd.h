...
EXTERN(void) jsimd_h2v1_downsample_mmi
        (JDIMENSION image_width, int max_v_samp_factor,
         JDIMENSION v_samp_factor, JDIMENSION width_blocks,
         JSAMPARRAY input_data, JSAMPARRAY output_data);
...
EXTERN(void) jsimd_h2v1_upsample_mmi
        (int max_v_samp_factor, JDIMENSION output_width, JSAMPARRAY input_data,
         JSAMPARRAY *output_data_ptr);
EXTERN(void) jsimd_h2v2_upsample_mmi
        (int max_v_samp_factor, JDIMENSION output_width, JSAMPARRAY input_data,
         JSAMPARRAY *output_data_ptr);
...
EXTERN(void) jsimd_convsamp_mmi
        (JSAMPARRAY sample_data, JDIMENSION start_col, DCTELEM *workspace);
...
EXTERN(void) jsimd_idct_2x2_mmi
        (void *dct_table, JCOEFPTR coef_block, JSAMPARRAY output_buf,
         JDIMENSION output_col);
EXTERN(void) jsimd_idct_4x4_mmi
        (void *dct_table, JCOEFPTR coef_block, JSAMPARRAY output_buf,
         JDIMENSION output_col);
