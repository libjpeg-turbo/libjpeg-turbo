...
EXTN(jsimd_h2v1_fancy_upsample_avx2):
    ...
    vpsrldq     xmm10, xmm9, (SIZEOF_XMMWORD - 1)
                ; (ff -- -- -- ... -- --) LSB is ff

    vpslldq     xmm9, xmm9, (SIZEOF_XMMWORD - 1)
    vperm2i128  ymm9, ymm9, ymm9, 1
                ; (---- ---- ... ---- ---- ff) MSB is ff
...
.upsample:
    ...
    vpunpcklbw  ymm8, ymm3, ymm0
                ; ymm8 = ( 9 10 11 12 13 14 15 16 25 26 27 28 29 30 31 32)
...
.rowloop:
    ...
    vpcmpeqb    xmm9, xmm9, xmm9
    vpsrldq     xmm10, xmm9, (SIZEOF_XMMWORD - 2)
                ; (ffff ---- ---- ... ---- ----) LSB is ffff
