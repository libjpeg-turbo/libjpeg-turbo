;
; jchuff-ssse3.asm - Huffman entropy encoding routines.
;
...
;
; GLOBAL(JOCTET*)
; jsimd_chuff_encode_one_block_ssse3 (Dworking_state * state, JOCTET *buffer, JCOEFPTR block, int last_dc_val,
...
%define put_bits        edi
        ...
        align   16
        global  EXTN(jsimd_chuff_encode_one_block_ssse3)

EXTN(jsimd_chuff_encode_one_block_ssse3):
        push    ebp
...
.nbits_end:
        ...
        kloop_prepare 32, 42, 49, 56, 57, 50, 43, 36, 29, 22, 15, 23, 30, 37, 44, 51, 58, 59, 52, 45, 38, 31, 39, 46, 53, 60, 61, 54, 47, 55, 62, 63, 63, xmm0, xmm1, xmm2, xmm3
