                                          ...
                                          c_derived_tbl *actbl)
{
  ...
  /* Load rows of DCT block coefficients in zig-zag order. */
  ...
  row1 = vld1q_lane_s16(block + 17, row1, 0);
  ...
  row2 = vld1q_lane_s16(block + 12, row2, 0);
  ...
  row3 = vld1q_lane_s16(block + 27, row3, 0);
  ...
  uint16x8_t row0_mask = vshlq_u16(
            vreinterpretq_u16_s16(vshrq_n_s16(row0, 15)), vnegq_s16(row0_lz));
  uint16x8_t row1_mask = vshlq_u16(
            vreinterpretq_u16_s16(vshrq_n_s16(row1, 15)), vnegq_s16(row1_lz));
  uint16x8_t row2_mask = vshlq_u16(
            vreinterpretq_u16_s16(vshrq_n_s16(row2, 15)), vnegq_s16(row2_lz));
  uint16x8_t row3_mask = vshlq_u16(
            vreinterpretq_u16_s16(vshrq_n_s16(row3, 15)), vnegq_s16(row3_lz));
  ...
  /* Load last four rows of DCT block coefficients in zig-zag order. */
  row4 = vld1q_lane_s16(block + 35, row4, 0);
  ...
  row5 = vld1q_lane_s16(block + 29, row5, 0);
  ...
  row6 = vld1q_lane_s16(block + 58, row6, 0);
  ...
  row7 = vld1q_lane_s16(block + 53, row7, 0);
  ...
  uint16x8_t row4_mask = vshlq_u16(
            vreinterpretq_u16_s16(vshrq_n_s16(row4, 15)), vnegq_s16(row4_lz));
  uint16x8_t row5_mask = vshlq_u16(
            vreinterpretq_u16_s16(vshrq_n_s16(row5, 15)), vnegq_s16(row5_lz));
  uint16x8_t row6_mask = vshlq_u16(
            vreinterpretq_u16_s16(vshrq_n_s16(row6, 15)), vnegq_s16(row6_lz));
  uint16x8_t row7_mask = vshlq_u16(
            vreinterpretq_u16_s16(vshrq_n_s16(row7, 15)), vnegq_s16(row7_lz));
