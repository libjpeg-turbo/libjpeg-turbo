 ...
 * reference, the C implementation 'jpeg_idct_slow' can be found in jidctint.c.
 *
...
#else
  int16x4_t consts1 = vld1_s16(jsimd_idct_islow_neon_consts);
  int16x4_t consts2 = vld1_s16(jsimd_idct_islow_neon_consts + 4);
  int16x4_t consts3 = vld1_s16(jsimd_idct_islow_neon_consts + 8);
