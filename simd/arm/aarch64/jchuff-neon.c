...
const static uint8_t jsimd_huff_encode_one_block_consts[] = {
    0,   1,   2,   3,  16,  17,  32,  33,
   18,  19,   4,   5,   6,   7,  20,  21,
                                          ...
                                          c_derived_tbl *actbl)
{
  ...
  uint8x16x4_t idx_rows_0123 = vld1q_u8_x4(
                          jsimd_huff_encode_one_block_consts + 0 * DCTSIZE);
  uint8x16x4_t idx_rows_4567 = vld1q_u8_x4(
                          jsimd_huff_encode_one_block_consts + 8 * DCTSIZE);
#else
  /* GCC does not currently support intrinsics vl1dq_<type>_x4(). */
  uint8x16_t idx_row_0, idx_row_1, idx_row_2, idx_row_3,
             idx_row_4, idx_row_5, idx_row_6, idx_row_7;
  idx_row_0 = vld1q_u8(jsimd_huff_encode_one_block_consts + 0 * DCTSIZE);
  idx_row_1 = vld1q_u8(jsimd_huff_encode_one_block_consts + 2 * DCTSIZE);
  idx_row_2 = vld1q_u8(jsimd_huff_encode_one_block_consts + 4 * DCTSIZE);
  idx_row_3 = vld1q_u8(jsimd_huff_encode_one_block_consts + 6 * DCTSIZE);
  idx_row_4 = vld1q_u8(jsimd_huff_encode_one_block_consts + 8 * DCTSIZE);
  idx_row_5 = vld1q_u8(jsimd_huff_encode_one_block_consts + 10 * DCTSIZE);
  idx_row_6 = vld1q_u8(jsimd_huff_encode_one_block_consts + 12 * DCTSIZE);
  idx_row_7 = vld1q_u8(jsimd_huff_encode_one_block_consts + 14 * DCTSIZE);
  uint8x16x4_t idx_rows_0123 = { idx_row_0, idx_row_1, idx_row_2, idx_row_3 };
  uint8x16x4_t idx_rows_4567 = { idx_row_4, idx_row_5, idx_row_6, idx_row_7 };
#endif

  /* Load 8x8 block of DCT coefficients. */
#if defined(__clang__)
  int8x16x4_t tbl_rows_0123 = vld1q_s8_x4((int8_t *)(block + 0 * DCTSIZE));
  int8x16x4_t tbl_rows_4567 = vld1q_s8_x4((int8_t *)(block + 4 * DCTSIZE));
#else
  int8x16_t tbl_row_0, tbl_row_1, tbl_row_2, tbl_row_3,
            tbl_row_4, tbl_row_5, tbl_row_6, tbl_row_7;
  tbl_row_0 = vld1q_s8((int8_t *)(block + 0 * DCTSIZE));
  tbl_row_1 = vld1q_s8((int8_t *)(block + 1 * DCTSIZE));
  tbl_row_2 = vld1q_s8((int8_t *)(block + 2 * DCTSIZE));
  tbl_row_3 = vld1q_s8((int8_t *)(block + 3 * DCTSIZE));
  tbl_row_4 = vld1q_s8((int8_t *)(block + 4 * DCTSIZE));
  tbl_row_5 = vld1q_s8((int8_t *)(block + 5 * DCTSIZE));
  tbl_row_6 = vld1q_s8((int8_t *)(block + 6 * DCTSIZE));
  tbl_row_7 = vld1q_s8((int8_t *)(block + 7 * DCTSIZE));
  int8x16x4_t tbl_rows_0123 = { tbl_row_0, tbl_row_1, tbl_row_2, tbl_row_3 };
  int8x16x4_t tbl_rows_4567 = { tbl_row_4, tbl_row_5, tbl_row_6, tbl_row_7 };
#endif

  /* Initialise extra lookup tables. */
  int8x16x4_t tbl_rows_2345 = { tbl_rows_0123.val[2], tbl_rows_0123.val[3],
                                tbl_rows_4567.val[0], tbl_rows_4567.val[1]
                              };
  int8x16x3_t tbl_rows_567 = { tbl_rows_4567.val[1], tbl_rows_4567.val[2],
                               tbl_rows_4567.val[3]
                             };
  ...
  uint8x8_t bitmap_mask = { 0x80, 0x40, 0x20, 0x10, 0x08, 0x04, 0x02, 0x01 };
  ...
  bit_buf_type put_buffer = state_ptr->cur.put_buffer.c;
  ...
  /* number of non-zero coefficients. If the bitmap is not too sparse (<16 */
  /* zero AC coefficients) it is beneficial to use NEON; else we compute */
  ...
  state_ptr->cur.put_buffer.c = put_buffer;
